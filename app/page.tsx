    ...
    <div className="p-8 max-w-5xl mx-auto space-y-8">
      ...
      {!data ? (
        ...
        <>
          ...
          {/* Now Playing — hide sessions not updated in the last 10 minutes */}
          {data.nowPlaying.filter(i => Date.now() - i.updatedAt < 600_000).length > 0 && (
            <div>
              ...
              <div className="rounded-xl border border-[#2a2a3a] bg-[#1c1c28] divide-y divide-[#2a2a3a]">
                {data.nowPlaying.filter(i => Date.now() - i.updatedAt < 600_000).map(item => {
